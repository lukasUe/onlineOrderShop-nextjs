const jsondb = {
    products: [
        {
            designation: 'crispy Burger',
            description: 'american styler Burger',
            category: 'main dish',
            price: 6.99,
            url: 'burger',
        ...
        {
            designation: 'Muffin',
            description: 'Very delecious choco Muffins',
            category: 'dessert',
            price: 2.50,
            url: 'muffin',
